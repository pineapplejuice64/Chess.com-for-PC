...
let appIconPath = path.join(__dirname, "icon.png"); // Path to your icon
let appIcon = null;
function createTrayIcon() {
    // Make sure Tray is initialized before calling any methods on it
    if (!appIcon) {
        appIcon = new Tray(appIconPath); // Only initialize Tray if it hasn't been already
        ...
        appIcon.setToolTip("Chess.com"); // Set tooltip after initializing Tray
